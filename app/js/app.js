...
$(document).on('click', 'li', function() {
    ...
    for (var i = 0; i <= answers.length; i++) {
        if ($(this).text() === answers[i].answer) {
            ...
            if (score == 1) {
                $('.burger-box').append('<img src="../images/top-bun.svg" style="height:100px;width:100px;float:right" alt="top-bun"></img>');
        }
            else if (score == 2) {
                $('.burger-box').prepend('<img src="../images/lettuce.svg" style="height:100px;width:100px;float:right" alt="lettuce"></img>');
            }
            else if (score == 3) {
                $('.burger-box').prepend('<img src="../images/tomatoes.svg" style="height:100px;width:100px;float:right" alt="tomatoes"></img>');
            }
            else if (score == 4) {
                $('.burger-box').prepend('<img src="../images/patty.svg" style="height:100px;width:100px;float:right" alt="patty"></img>');
            }
            else if (score == 5) {
                $('.burger-box').prepend('<img src="../images/bottom-bun.svg" style="height:100px;width:100px;float:right" alt="bottom-bun"></img>');
            }
        } else {
            $('li').click(false);
